                ...
                <v-card-text>
                  <v-layout wrap row align-center>
                    ...
                    <v-flex xs12 text-xs-right>
                      ...
                      <v-btn color="primary" @click.native="goStep(0);">Guardar</v-btn>
                    </v-flex>
                  </v-layout>
                </v-card-text>
              </v-card>
          ...
          <v-layout wrap row>
            <v-flex xs12>
              <h3 class="text-xs-center">
                <b>¿CONFIRMAR REGISTRO DE PLAN DE ACCIÓN?</b>
              </h3>
            </v-flex>
          </v-layout>
        </v-card-text>
...
export default {
  ...
  methods: {
    addNewPlan() {
      ...
      const id_incidencia = this.$route.params.id;
      this.$store.commit("planAccion/UPDATE_DATOS", { id_incidencia });
    },
    goPlan() {
      this.active = 1;
      this.dialog = false;
